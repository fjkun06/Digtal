...
export default function AboutUs() {
  return (
    <Grid mt={10}>
      ...
      >
        <Typography className="font-semibold text-[color:rebeccapurple] text-opacity-60 max-w-5xl text-center text-[55px] font-['Poppins']">
          We are professionals, Bringing to you a.
        </Typography>
        <Typography className="capitalize font-bold text-[62px] text-[color:rebeccapurple]">
      ...
      <Container maxWidth="lg" className="my-24">
        ...
        <Stack direction="column" className="my-32" gap={7}>
          <Stack direction="row" gap={2}>
            <Typography className="font-['Passion_One'] flex items-center tracking-[-0.04em] text-[196px] leading-[50px]">
              “
            </Typography>
            <Typography
              component="p"
              className="font-[Poppins] font-semibold text-[21px] text-[rebeccapurple] text-opacity-60 text-center"
            >
              Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt
              qui esse pariatur duis deserunt mollit dolore cillum minim tempor
        ...
        <Grid
          ...
          spacing={6}
          columns={12}
          className="max-w-[1038px] mx-auto"
        >
          <Grid xs={4} item>
            <Stack>
              ...
              <Typography className="font-['Passion_One'] text-[#2B0A3D] text-[90px] flex items-center mx-auto">
                160k+
              </Typography>
            </Stack>
          </Grid>
